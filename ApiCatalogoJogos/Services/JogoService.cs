...
namespace ApiCatalogoJogos.Services
{
    public class JogoService : IJogoService
    {
        ...
        public async Task Atualizar(Guid id, JogoInputModel jogo)
        {
            ...
            entidadeJogo.AlterarNome(jogo.Nome);
            entidadeJogo.AlterarProdutora(jogo.Produtora);
            entidadeJogo.AlterarPreco(jogo.Preco);
        ...
        public async Task Atualizar(Guid id, double preco)
        {
            ...
            entidadeJogo.AlterarPreco(preco);
        ...
        public async Task<JogoViewModel> Inserir(JogoInputModel jogo)
        {
            ...
            var jogoInsert = new Jogo(jogo.Nome, jogo.Produtora, jogo.Preco);
